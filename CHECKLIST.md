# Site customization checklist · Sungshim Plumbing (hs-018-sungshim)
Wave 4 · Copperline · claim/$297 + hosting/$99 bar required. Rebuilt 2026-09-25 (CR 2026-09-25b, CEO change request).

Before preview send:
- [x] Business name everywhere (title, wordmark, footer, schema)
- [x] City / service area
- [x] Phone click-to-call is the main CTA (tel-only; no public email)
- [x] Address per packet (FARM-PACKETS-WAVE4.md)
...
Owner first name in human spots: Gyuseon
NAP/phone per packet: 6595 Fairlynn Blvd, Yorba Linda CA 92886 · 714-398-7614
lang: en-US · geo: CA
...
Lead notes: No license number on page. Owner referred to by name (no gendered pronouns).
Prior folder backed up at ops/cr-2026-09-25b/backup/hs-018-sungshim/.
...
the home city (Yorba Linda) plus areas the packet itself lists. Packet line: "Coverage: Yorba Linda / North OC".
Extra areas kept from the packet: none. Region label: North Orange County (plain description, from the packet).
